...
export const tools: Tool[] = [
  ...
  { title: 'YAML to JSON', description: 'Convert YAML config files to JSON.', href: '/tools/yaml-to-json', icon: '⇄', color: 'bg-purple-500/10 text-purple-500', accent: 'from-purple-500 to-purple-400', category: 'data', comingSoon: true },
  ...
  // CSS
  { title: 'CSS Gradient Generator', description: 'Build linear and radial gradients visually.', href: '/tools/css-gradient', icon: '▓', color: 'bg-violet-500/10 text-violet-500', accent: 'from-violet-500 to-violet-400', category: 'css', comingSoon: true },
  { title: 'Box Shadow Builder', description: 'Create and preview CSS box-shadow values.', href: '/tools/box-shadow', icon: '◻', color: 'bg-sky-500/10 text-sky-500', accent: 'from-sky-500 to-sky-400', category: 'css', comingSoon: true },
  { title: 'Color Contrast Checker', description: 'Check WCAG AA/AAA compliance for text colors.', href: '/tools/color-contrast', icon: '◑', color: 'bg-rose-500/10 text-rose-500', accent: 'from-rose-500 to-rose-400', category: 'css', comingSoon: true },

  // SVG
  { title: 'SVG Optimizer', description: 'Minify SVG files. Removes metadata and unused elements.', href: '/tools/svg-optimizer', icon: '◈', color: 'bg-cyan-500/10 text-cyan-500', accent: 'from-cyan-500 to-cyan-400', category: 'svg', comingSoon: true },
  { title: 'SVG to PNG', description: 'Export SVG to PNG at any resolution, in browser.', href: '/tools/svg-to-png', icon: '↓', color: 'bg-lime-500/10 text-lime-500', accent: 'from-lime-500 to-lime-400', category: 'svg', comingSoon: true },
  { title: 'Favicon Generator', description: 'Create ICO and PNG favicons from any SVG or image.', href: '/tools/favicon-generator', icon: '⬡', color: 'bg-fuchsia-500/10 text-fuchsia-500', accent: 'from-fuchsia-500 to-fuchsia-400', category: 'svg', comingSoon: true },
];
